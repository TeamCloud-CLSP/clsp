...
--
ALTER TABLE `app_users`
  ADD CONSTRAINT `FK_C2502824DF990765` FOREIGN KEY (`student_registration_id`) REFERENCES `student_registrations` (`id`);

--
-- Constraints for table `classes`
--
ALTER TABLE `classes`
  ADD CONSTRAINT `FK_2ED7EC5591CC992` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`),
  ADD CONSTRAINT `FK_2ED7EC5833D8F43` FOREIGN KEY (`registration_id`) REFERENCES `professor_registrations` (`id`);

--
-- Constraints for table `courses`
--
ALTER TABLE `courses`
  ADD CONSTRAINT `FK_A9A55A4C82F1BAF4` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`),
  ADD CONSTRAINT `FK_A9A55A4CA76ED395` FOREIGN KEY (`user_id`) REFERENCES `app_users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `media`
--
ALTER TABLE `media`
  ADD CONSTRAINT `FK_6A2CA10CA76ED395` FOREIGN KEY (`user_id`) REFERENCES `app_users` (`id`);
...
--
ALTER TABLE `module_cn_keyword`
  ADD CONSTRAINT `FK_93E7E9815A496692` FOREIGN KEY (`cn_id`) REFERENCES `module_cn` (`id`);
...
--
ALTER TABLE `module_question_heading`
  ADD CONSTRAINT `FK_1F83A4578C84753` FOREIGN KEY (`ge_id`) REFERENCES `module_ge` (`id`),
  ADD CONSTRAINT `FK_1F83A457A6A7E01` FOREIGN KEY (`ls_id`) REFERENCES `module_ls` (`id`),
  ADD CONSTRAINT `FK_1F83A45C578A297` FOREIGN KEY (`dw_id`) REFERENCES `module_dw` (`id`),
  ADD CONSTRAINT `FK_1F83A45C77172EE` FOREIGN KEY (`qu_id`) REFERENCES `module_qu` (`id`),
  ADD CONSTRAINT `FK_1F83A45E7BD46B8` FOREIGN KEY (`lt_id`) REFERENCES `module_lt` (`id`);

--
-- Constraints for table `module_question_item`
--
ALTER TABLE `module_question_item`
  ADD CONSTRAINT `FK_122E085962FE64EC` FOREIGN KEY (`heading_id`) REFERENCES `module_question_heading` (`id`);

--
-- Constraints for table `professor_registrations`
--
ALTER TABLE `professor_registrations`
  ADD CONSTRAINT `FK_40122D7F591CC992` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_40122D7F7D2D84D5` FOREIGN KEY (`professor_id`) REFERENCES `app_users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_40122D7F7E3C61F9` FOREIGN KEY (`owner_id`) REFERENCES `app_users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `song`
--
ALTER TABLE `song`
  ADD CONSTRAINT `FK_33EDEEA1F8BD700D` FOREIGN KEY (`unit_id`) REFERENCES `unit` (`id`);
...
--
ALTER TABLE `student_registrations`
  ADD CONSTRAINT `FK_642A9791B55C8B6` FOREIGN KEY (`prof_registration_id`) REFERENCES `professor_registrations` (`id`),
  ADD CONSTRAINT `FK_642A979CFC54FAB` FOREIGN KEY (`designer_id`) REFERENCES `app_users` (`id`),
  ADD CONSTRAINT `FK_642A979EA000B10` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`);

--
-- Constraints for table `unit`
--
ALTER TABLE `unit`
  ADD CONSTRAINT `FK_DCBB0C53591CC992` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`);
